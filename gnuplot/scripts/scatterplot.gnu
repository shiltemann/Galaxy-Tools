...
set output "out.png"
plot inputfile u 2:4 with points lc rgb mydotcolour pt dotstyle ps dotsize notitle 


#smooth 'unique', 'frequency', 'cumulative', 'cnormal', 'kdensity', 'acsplines', 'csplines', 'bezier' or 'sbezier'
